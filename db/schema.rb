...
ActiveRecord::Schema.define(version: 20160223124737) do
  ...
  add_index "user_choices", ["answer_id"], name: "index_user_choices_on_answer_id", using: :btree
  add_index "user_choices", ["user_id"], name: "index_user_choices_on_user_id", using: :btree
